        ...
        >
            ...
            <el-form-item prop="reason">
                ...
                <el-radio-group v-model="complaint.reason" class="reason-choose">
                    ...
                    <!-- Пасля гэтага радка — прамежак: вышэй тры прычыны, па якіх слова прыбіраюць,
                         ніжэй тры, па якіх яго правяць. Аднолькавы спіс з шасці пунктаў хаваў
                         гэтую розніцу, і выбіраць даводзілася чытаючы ўсе шэсць. -->
                    <el-radio class="reason-gap" label="hostile-language"> мова варожасці;</el-radio>
                    <!-- асобны шлях: не выдаліць, а паправіць. Такіх зваротаў найбольш,
                         і раней яны ішлі пад «іншае» разам са скаргамі на змест -->
                    <el-radio label="fix-mistake"> памылка ў тэксце;</el-radio>
                    <!-- Не пра тое, што слова кепскае, а пра тое, што яму не хапае
                         пазнакі. Аўтару такая скарга нічым не пагражае: слова
                         застаецца, мяняецца толькі спіс тэгаў. -->
                    <el-radio label="add-tag"> хачу дадаць тэг;</el-radio>
