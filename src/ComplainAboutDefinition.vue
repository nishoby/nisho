    ...
    <div class="complaint-wrapper">
        ...
        <el-form :model="complain"
            ...
            <div class="complaint-block" v-if="definition">
                ...
                <div class="complaint-desc">
                    <router-link class="card-title" :to="{name: 'term', params: {id: definition.term.id}}">
            ...
            <el-form-item label="Чаму трэба выдаліць тлумачэнне:" prop="reason">
                <el-radio-group v-model="complain.reason">
                    <el-radio label="unclear-term">
                        унутраны жарт без кантэксту ці не рэальны тэрмін
                    </el-radio>
                    <el-radio label="personal-data">
                        імя ці іншыя асабістыя дадзеныя
                    </el-radio>
                    <el-radio label="hostile-language">
                        мова варожасці
                    </el-radio>
