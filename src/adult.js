...
// «Секс» праз «е» — правільнае беларускае напісанне: «э» ідзе пасля «д» і «т»
// («тэкст», «інтэрнэт»), а пасля «с» — «е». «Сэкс» — тарашкевіца; ён у базе
// ёсць, словы на ім вісяць, і перамыкач мусіць бачыць абодва.
//
